# INICIO RÁPIDO - GUÍA PARA NUEVOS DESARROLLADORES
...
El token expira en 30 minutos. El frontend limpia automáticamente localStorage y te redirige a login.

### ¿Cómo cambio la contraseña?

Por ahora no hay endpoint de cambio de contraseña. Necesita ser implementado.

### ¿Puedo usar otra base de datos?

Sí, SQLAlchemy soporta PostgreSQL, MySQL, etc. Cambia `BASE_DATOS_URL`.

### ¿Cómo depuro el backend?

Usa breakpoints en VS Code con Python debugger, o agrega `print()` statements.

### ¿Cómo depuro el frontend?

Usa las Developer Tools (F12) del navegador, o agrega `console.log()`.
