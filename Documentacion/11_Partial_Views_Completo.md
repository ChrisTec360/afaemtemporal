...
1. Usa siempre los partial views en lugar de crear componentes nuevos
2. Importa desde el index.js para código más limpio
3. Reutiliza los mismos componentes en todo el proyecto
4. Mantén consistencia visual en toda la aplicación
5. Documenta componentes personalizados que crees
