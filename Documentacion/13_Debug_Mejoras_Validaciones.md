...
Si el backend espera formato diferente, se puede ajustar el código. Contesta:
...
2. ¿El backend logs dice qué espera?
   - Revisa backend logs en 192.168.1.120:8000
...
```
1. Error exacto: [el error que ves]
2. Valor de la fecha en consola: [que ves]
3. Respuesta del backend: [qué retorna]
4. ¿Qué espera el backend? [describe]
```

## Próximo Paso

Prueba ahora y comparte qué error ves en la consola.
