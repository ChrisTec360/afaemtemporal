...
- Las migraciones deben ser idempotentes (ejecutarse múltiples veces sin problemas)
- Cada migración debe ser reversible (tener up y down)
- Los datos iniciales van en migraciones de seed
