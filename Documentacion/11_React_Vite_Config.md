...
Si estás desarrollando una aplicación para producción, se recomienda usar TypeScript con reglas de linting conscientes de tipos. 

Consulta el TS template en el repositorio oficial de Vite para informarte sobre cómo integrar TypeScript y typescript-eslint en tu proyecto.
...
- HMR habilitado para desarrollo rápido
