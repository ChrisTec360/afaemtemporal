...
export default function ProximoEntrenador() {
  ...
  const [documentStatus, setDocumentStatus] = useState(REQUIRED_DOCUMENTS);
  ...
  useEffect(() => {
    try {
      ...
      if (raw) {
        ...
        setUserInfo(user);
        // LLENAR AUTOMÁTICAMENTE LOS DATOS PERSONALES CON LA INFO DEL USUARIO LOGUEADO
