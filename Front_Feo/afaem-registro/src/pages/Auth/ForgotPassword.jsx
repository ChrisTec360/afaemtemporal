      ...
      <div className="card shadow-lg w-100" style={{ maxWidth: 420, marginTop: 48, marginBottom: 48 }}>
        ...
        {success ? (
          <div style={{ background: '#d4edda', color: '#155724', padding: 12, borderRadius: 6, marginBottom: 12 }}>
            ...
            <button className="btn-secondary" style={{ width: '100%', marginTop: 8 }} onClick={() => navigate('/login')}>
              Volver al inicio
            </button>
          </div>
        ) : (
          <>
            ...
            <button className="btn-secondary" style={{ width: '100%', marginTop: 12 }} onClick={() => navigate('/login')}>
              Volver al inicio
            </button>
          </>
        )}
