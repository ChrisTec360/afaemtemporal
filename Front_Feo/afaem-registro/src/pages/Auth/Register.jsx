...
function Register() {
	...
	const checkAndMarkDuplicates = async (data) => {
	...
	const handleSubmit = async (e) => {
		...
		setErrors(newErrors);
		if (Object.values(newErrors).some(Boolean)) { alert('Corrige los errores marcados en rojo antes de continuar.'); return; }
		...
		<div className="register">
			...
			<div className="form-container">
				<div ref={cardRef} className="card">
					...
					<h2>Registro — Presidente de Equipo</h2>
						...
						<div className="form-grid">
							...
							<div className="form-field col-span-4" style={{ textAlign: 'center', marginTop: 8 }}>
								<p style={{ margin: 0, fontSize: '14px' }}>
									¿Ya tienes cuenta? <Link to="/login" style={{ color: '#0b4ea6', fontWeight: 700, textDecoration: 'none' }}>Inicia sesión</Link>
								</p>
							</div>
