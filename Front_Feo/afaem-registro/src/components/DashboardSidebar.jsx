...
const DashboardSidebar = ({ userEmail }) => {
  ...
  const menuItems = [
    { label: 'Inicio', icon: FaHome, path: '/trainer' },
    { label: 'Equipos', icon: FaFootballBall, path: '/trainer/teams' },
    { label: 'Jugadores', icon: FaUsers, path: '/trainer/players' },
    { label: 'Solicitudes', icon: FaClipboard, path: '/trainer/requests' },
    { label: 'Reportes', icon: FaChartBar, path: '/trainer/reports' },
    { label: 'Configuración', icon: FaCog, path: '/trainer/settings' },
  ];
